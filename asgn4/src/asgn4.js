...
function initTextures() {
  ...
  img0.onload = function() {sendImageToTEXTURE0(img0);};
  ...
  // Register the event handler to be called on loading an image
  img1.onload = function() {sendImageToTEXTURE1(img1);};
  // Tell the browser to load an image
  img1.src = 'sky.jpg';
...
function sendImageToTEXTURE0(img) {
...
function sendImageToTEXTURE1(img) {
  var texture = gl.createTexture();
  if (!texture) {
    console.log('Failed to create the texture object');
    return false;
